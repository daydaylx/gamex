...
- ✅ **Phase 2 (Logik):** `scale_1_10` Bedingungen und erweiterte Compare-Logik sind implementiert. Tag-Validierung steht noch aus.
...
- **Status: BEHOBEN** (Frontend unterstützt nun `scale_1_10` Bedingungen)
...
- Frontend `evaluateDependency()` unterstützt `scale_1_10`.
