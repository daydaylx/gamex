...
describe('Validation Service', () => {
  ...
  describe('scale_0_10 validation', () => {
    it('should validate values in range 0-10', () => {
      const template = createTemplate([
    ...
    it('should error on values outside range', () => {
      ...
      expect(result.errors[0]?.message).toContain('zwischen 0 und 10');
    });

    it('should error on negative values', () => {
      const template = createTemplate([
        { id: 'q1', schema: 'scale_0_10', risk_level: 'A', tags: [], label: 'Q1' },
      ]);
      const responses: ResponseMap = {
